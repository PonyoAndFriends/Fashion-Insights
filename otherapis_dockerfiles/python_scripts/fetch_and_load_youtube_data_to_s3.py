...
def get_videos_with_details(youtube, input_category_data, s3_dict, file_topic, max_results=3):
    ...
    for category in categories:
        ...
        for video_info in video_details_response["items"]:
            ...
            if 180 <= duration <= 1800:
                videos.append({
                    ...
                    "thumbnailUrl": video_info["snippet"]["thumbnails"]["high"]["url"],
        ...
        s3_dict['file_path'] = f"/{file_topic}_raw_data/{now_string}/{gender}_{first_depth}_{second_depth}_{file_topic}_data.json"
...
if __name__ == "__main__":
    ...
    run_func_multi_thread.execute_in_threads(get_videos_with_details, args_list, max_threads)
