...
# S3 경로
man_data_path = (
    "s3a://pcy-test-rawdata-bucket/2025-01-08/29cm/29cm_product/Man/*/*.json"
)
woman_data_path = (
    "s3a://pcy-test-rawdata-bucket/2025-01-08/29cm/29cm_product/Woman/*/*.json"
)
...
master_category_output_path = (
    f"s3a://pcy-test-rawdata-bucket/{today}/29cm/silver_data/master_category_tb/"
)
...
product_detail_output_path = (
    f"s3a://pcy-test-rawdata-bucket/{today}/29cm/silver_data/product_detail_tb/"
)
...
# ranking_tb 저장
ranking_output_path = (
    f"s3a://pcy-test-rawdata-bucket/{today}/29cm/silver_data/ranking_tb/"
)
