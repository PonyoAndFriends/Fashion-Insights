...
from musinsa_mappingtable import SEXUAL_CATEGORY_DYNAMIC_PARAMS, mapping_2depth_kor
...
def making_ranking_table(spark, json_path, master_category_code, today_date):
    ...
    for i in range(1, 18):
        ...
        temp_df = temp_df.withColumn(
            "category", lit(master_category_code).cast("string")
        )
        ...
        for categorydepth in category:
            ...
            for detailcategories in categories[1]:
                ...
                for detail_category4 in detail_category[1].values():
                    ...
                    sexualeng = (
                        "F" if sexual == "여성" else "M" if sexual == "남성" else None
                    )
