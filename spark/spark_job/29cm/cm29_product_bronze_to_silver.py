...
# S3 경로
man_data_path = f"s3a://pcy-test-rawdata-bucket/bronze_layer/{today}/29cm/29cm_product/Man/*/*.json"
...
master_category_output_path = f"s3a://pcy-test-rawdata-bucket/silver_layer/{today}/29cm/master_category_tb/"
...
product_detail_output_path = f"s3a://pcy-test-rawdata-bucket/silver_layer/{today}/29cm/product_detail_tb/"
...
# ranking_tb 저장
ranking_output_path = f"s3a://pcy-test-rawdata-bucket/silver_layer/{today}/29cm/ranking_tb/"
...
# sub_category_tb 저장
sub_category_output_path = f"s3a://pcy-test-rawdata-bucket/silver_layer/{today}/29cm/sub_category_tb/"
