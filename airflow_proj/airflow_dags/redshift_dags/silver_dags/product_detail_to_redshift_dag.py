...
from otherapis.redshift_dags.silver_dags.custom_sql_operators.custom_query_operator import RedshiftQueryOperator
from otherapis.redshift_dags.silver_dags.custom_sql_operators.custom_refresh_table_operator import RefreshTableOperator
from otherapis.redshift_dags.silver_dags.custom_sql_operators.custom_sql_modules.query_dag_dependencies import (
...
# DAG 정의
with DAG(
    dag_id="product_detail_silver_data_to_redshift_dag",
