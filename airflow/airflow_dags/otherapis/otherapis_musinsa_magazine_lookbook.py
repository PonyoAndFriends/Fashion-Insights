...
# API 정보
KEY_URL = r""
BASE_URL = "https://content.musinsa.com/api2/content/magazine-content/v1/lookbook"
...
with DAG(
    dag_id='musinsa_magazine_news_api_to_s3_dag',
    ...
    def fetch_data_task(**kwargs):
        ...
        ti = kwargs['ti']
        news_ids = ti.xcom_pull(task_ids='fetch_data_task')
        ...
        for Lookbookid in news_ids:
            url = f"https://www.musinsa.com/mz/magazine/view/{Lookbookid}"
